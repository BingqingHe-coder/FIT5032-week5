...
const validateReason = (blur) => {
  ...
  if (formData.value.reason.includes ('friend')) {
    if (blur) validateFriend.value = true;
  } else {
    validateFriend.value = false
  }
  }

  const validateFriend = ref(false)
</script>
...
<template>
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="validateFriend" style="color: green;">Great to have a friend</div>
          </div>
          <div class="mb-3">
  ...
  <div class="row mt-5">
    ...
    <DataTable :value="submittedCards"  style = "background-color: azure" tableStyle="min-width: 50rem">
